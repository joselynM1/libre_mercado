...
try {
    ...
    $total_venta  = 0;
    // CONFIGURACIÓN CRÍTICA: ID 2 para registrar que la venta pertenece a la Sucursal Centro
    $id_sucursal  = 2; 
    ...
    if ($clienteExistente) {
        ...
        // Insertamos usando exactamente los campos de base de datos
    ...
    unset($_SESSION['comprador_nombre'], $_SESSION['comprador_email']);
    $status  = "success";
...
<body>
    <div class="card-resultado">
        <div style="font-size:12px; color:#b7950b; font-weight:bold; margin-bottom:15px; letter-spacing: 0.5px;">🔵 SUCURSAL CENTRO— ENTORNO CENTRALIZADO</div>
