...
<head>
    <meta charset="UTF-8">
    <title>ML Mercado - Sucursal Centro</title>
    <style>
        body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0; padding: 0; background-color: #f5f5f5; }
        .navbar { background-color: #c3e8ff; padding: 12px 50px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 2px rgba(0,0,0,0.1); }
        ...
        .cart-btn { background: none; border: 1px solid #1a5276; padding: 8px 15px; border-radius: 5px; cursor: pointer; font-weight: bold; text-decoration: none; color: #1a5276; display: inline-block; }
        ...
        .nav-link { color: #1a5276; text-decoration: none; font-size: 13px; }
        ...
        .add-to-cart { background-color: #1a5276; color: white; border: none; width: 100%; padding: 10px; border-radius: 4px; font-weight: bold; cursor: pointer; transition: background 0.2s; }
        .add-to-cart:hover { background-color: #154360; }
    </style>
</head>
<body>
    ...
    <main class="main-container">
        <div class="title">Catálogo completo de productos disponibles — Sucursal Centro</div>
