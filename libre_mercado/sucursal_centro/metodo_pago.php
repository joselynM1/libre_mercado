...
<head>
    <meta charset="UTF-8">
    <title>Método de Pago - Sucursal Centro</title>
    <style>
        body { font-family: 'Helvetica Neue', Arial, sans-serif; margin: 0; background-color: #f5f5f5; color: #333; }
        .navbar { background-color: #c3e8ff; padding: 12px 50px; display: flex; justify-content: space-between; align-items: center; }
        .logo { font-size: 22px; font-weight: bold; color: #1a5276; text-decoration: none; }
        .sucursal-badge { background-color: #1a5276; color: white; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: bold; }
        ...
        .step.active { color: #1a5276; font-weight: bold; }
        ...
        .step.active .step-circle { background: #1a5276; }
        ...
        select, input[type="text"], input[type="email"] { width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 6px; font-size: 15px; background-color: white; color: #333; box-sizing: border-box; }
        select:focus, input:focus { border-color: #1a5276; outline: none; }
        ...
        .btn-pagar { background-color: #1a5276; color: white; border: none; width: 100%; padding: 14px; border-radius: 6px; font-weight: bold; font-size: 16px; cursor: pointer; margin-top: 20px; }
        .btn-pagar:hover { background-color: #154360; }
        ...
        <div class="layout">
            <div class="col-formulario">
                <div class="card">
                    ...
                    <input type="text" name="nombre_cliente" id="nombre_cliente" placeholder="Ej: Juan Pérez" required>
