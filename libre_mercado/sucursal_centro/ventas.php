...
<head>
    ...
    <style>
        ...
        h1, h2 { color: #1a5276; }
        form { background: #e8f4fb; padding: 25px; border-radius: 5px; border: 1px solid #a9d4f5; }
        input, button { display: block; width: 95%; margin: 15px 0; padding: 12px; font-size: 16px; }
        button { background: #1a5276; color: white; border: none; cursor: pointer; width: 100%; font-weight: bold; }
        .alert { padding: 15px; margin-bottom: 20px; border-radius: 4px; font-weight: bold; }
        .success { background-color: #d4edda; color: #155724; border: 1px solid #c3e6cb; }
        .error { background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; }
        a { display: inline-block; margin-top: 15px; color: #1a5276; text-decoration: none; }
    </style>
</head>
<body>
<div class="container">
