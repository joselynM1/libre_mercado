...
<head>
    <meta charset="UTF-8">
    <title>Carrito - Sucursal Centro</title>
    <style>
        body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0; background-color: #f5f5f5; color: #333; }
        .navbar { background-color: #c3e8ff; padding: 12px 50px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.1); }
        ...
        .cart-info { font-size: 14px; font-weight: bold; color: #1a5276; }
        ...
        .btn-cant { background: none; border: none; font-size: 16px; cursor: pointer; font-weight: bold; color: #1a5276; }
        ...
        .btn-continuar { background-color: #1a5276; color: white; border: none; width: 100%; padding: 14px; border-radius: 6px; font-weight: bold; font-size: 16px; cursor: pointer; margin-top: 15px; transition: background 0.2s; }
        .btn-continuar:hover { background-color: #154360; }
        .btn-seguir { display: block; text-align: center; color: #1a5276; text-decoration: none; margin-top: 15px; font-size: 14px; }
