...
try {
    ...
    $total_venta  = 0;
    // CONFIGURACIÓN CRÍTICA: ID 3 para registrar que la venta pertenece a la Sucursal Sur
    $id_sucursal  = 3; 
    ...
    foreach ($items_carrito as $item) {
        ...
        // Descontar del inventario maestro de la sucursal sur
...
<body>
    <div class="card-resultado">
        <div style="font-size:12px; color:#b7950b; font-weight:bold; margin-bottom:15px; letter-spacing: 0.5px;">🟢 SUCURSAL SUR— ENTORNO CENTRALIZADO</div>
