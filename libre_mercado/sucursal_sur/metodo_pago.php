...
<head>
    <meta charset="UTF-8">
    <title>Método de Pago - Sucursal Sur</title>
    <style>
        body { font-family: 'Helvetica Neue', Arial, sans-serif; margin: 0; background-color: #f5f5f5; color: #333; }
        .navbar { background-color: #c8f5d4; padding: 12px 50px; display: flex; justify-content: space-between; align-items: center; }
        ...
        .step.active { color: #1a6b37; font-weight: bold; }
        ...
        .step.active .step-circle { background: #1a6b37; }
        ...
        select:focus, input:focus { border-color: #1a6b37; outline: none; }
        ...
        .btn-pagar { background-color: #1a6b37; color: white; border: none; width: 100%; padding: 14px; border-radius: 6px; font-weight: bold; font-size: 16px; cursor: pointer; margin-top: 20px; }
        .btn-pagar:hover { background-color: #145228; }
...
<body>
    ...
    <div class="progress-bar">
        ...
        <div class="line" style="background:#1a6b37;"></div>
